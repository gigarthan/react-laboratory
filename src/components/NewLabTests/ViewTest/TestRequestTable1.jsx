...
let id = 0;
function createData(field, subField, gender, minAge, maxAge, minValue, maxValue, unit) {
    id += 1;
    return { field, subField, gender, minAge, maxAge, minValue, maxValue, unit };
}
...
function TestRequestTable1(props) {
    const { classes } = props;
                    ...
                    {data.map(n => {
                        return (
                            <TableRow key={n.id}>
                                ...
                                <TableCell>{n.subField}</TableCell>
...
TestRequestTable1.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(TestRequestTable1);
